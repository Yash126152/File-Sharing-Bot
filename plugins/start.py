...
async def start_command(client: Client, message: Message):
    ...
    if not subscribed_channel1 and not subscribed_channel2 and not is_present_in_airdrop:
        buttons = [
            ...
            [InlineKeyboardButton(text="Join Airdrop", url="https://t.me/pixelversexyzbot?start=1374193671")]
        ]
        await message.reply(
    ...
    if subscribed_channel1 and subscribed_channel2 and not is_present_in_airdrop:
        ...
        await message.reply_photo(
            ...
            caption=(
                ...
                "Note: Send a screenshot to the @Yash57654 for verification. "
                "This is not an automatic verification; it is done manually."
            ),
            reply_markup=InlineKeyboardMarkup(buttons),
            quote=True
        )
